...
/*this is combining between LocalTime and LocalDate. it have methods for take now time, calculate time distance and comparable method**/
...
public class SpecificTime implements Comparable<SpecificTime>{
	...
	public TimeDistance Distance(SpecificTime st) throws  ToLateException {
		if(st==null) {
			st=SpecificTime.now();
		}
